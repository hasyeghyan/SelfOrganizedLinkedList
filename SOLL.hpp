...
class SOLL {
    ...
    public:
        ...
        void splice(Iter pos, SOLL& other);
        void splice(Iter pos, SOLL&& other);
        void splice(Iter pos, SOLL& other, Iter it);
        void splice(Iter pos, SOLL&& other, Iter it);
        void splice(Iter pos, SOLL& other, Iter first,Iter last);
        void splice(Iter pos, SOLL&& other, Iter first, Iter last);
        template <typename... Args>
...
template <typename T>    
SOLL<T>::SOLL(Iter first,Iter last) : SOLL() {
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::insert(Iter pos, const T& value) {
    auto* ins = pos.curr;
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::insert(Iter pos, T&& value) {
    auto* ins = pos.curr;
...
template <typename T>
typename SOLL<T>::Iter  SOLL<T>::insert(Iter pos, size_t count, const T& value ) {
    int i{};
    auto ans = pos;
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::insert(Iter pos, std::initializer_list<T> ilist) {
    int i{};
    auto ans = pos;
    for (auto i : ilist) {
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::insert(Iter pos, Iter first, Iter last) {
    int i{};
    auto ans = pos;
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::erase(Iter pos) {
...
template <typename T>
typename SOLL<T>::Iter SOLL<T>::erase(Iter first, Iter last) {
...
template <typename T>
void SOLL<T>::splice(Iter pos, SOLL& other) {
...
template <typename T>
void  SOLL<T>::splice(Iter pos, SOLL& other, Iter it) {
...
template <typename T>
void SOLL<T>::splice(Iter pos, SOLL& other, Iter first, Iter last) {
...
template <typename T>
template <typename... Args>
void SOLL<T>::emplace(Iter pos, Args&&... args) {
    auto* ins = pos.curr;
